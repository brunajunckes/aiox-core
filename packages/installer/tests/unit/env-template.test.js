...
describe('.env Template Generator', () => {
  describe('generateEnvContent', () => {
    it('should generate .env with empty API keys when none provided', () => {
      ...
      expect(content).toContain('OPENAI_REDACTED
      expect(content).toContain('ANTHROPIC_REDACTED
    ...
    it('should generate .env with optional service API keys', () => {
      ...
      expect(content).toContain('CLICKUP_REDACTED
      expect(content).toContain('GITHUB_REDACTED
      expect(content).toContain('EXA_REDACTED
    });
