...
_check_variables() {
  ...
  YANDEX360_CLIENT_REDACTED
  YANDEX360_ORG_ID="${YANDEX360_ORG_ID:-$(_readaccountconf_mutable YANDEX360_ORG_ID)}"
  YANDEX360_ACCESS_REDACTED
  YANDEX360_REFRESH_REDACTED
...
_get_token() {
  ...
  while true; do
    data="grant_type=device_code&code=$device_code&client_id=$YANDEX360_CLIENT_ID&client_REDACTED
...
_refresh_token() {
  ...
  data="grant_type=refresh_token&refresh_REDACTED
