...
docker mcp server add {mcp-name} --env NOTION_REDACTED
```
...
```
Resolution:
1. Set environment variable: export NOTION_REDACTED
2. Add to .env file: NOTION_REDACTED
3. Pass directly: docker mcp server add notion --env NOTION_REDACTED
```
