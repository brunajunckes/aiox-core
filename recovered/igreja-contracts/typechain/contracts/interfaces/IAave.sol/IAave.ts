...
export interface IAaveInterface extends utils.Interface {
  functions: {
  ...
  getFunction(
    nameOrSignatureOrTopic: "deposit" | "getUserAccountData" | "withdraw"
  ): FunctionFragment;
...
export interface IAave extends BaseContract {
